...
async function printPosBill() {
  ...
  document.getElementById("billbody").innerHTML =
    `<div style="font-family: 'Courier New', Courier, monospace; background: #fff; color: #1a1000; padding: 24px; border-radius: 8px; width: 100%; max-width: 400px; margin: 0 auto;" id="printbill">
      <div style="text-align: center; margin-bottom: 16px;"><div style="font-size: 22px; font-weight: bold; color: #1a1000; margin-bottom: 4px;">${SHOP.name}</div><div style="font-size: 12px; color: #555;">${SHOP.addr}</div><div style="font-size: 12px; color: #555;">${SHOP.ph ? `Ph: ${SHOP.ph}` : ""}</div></div>
